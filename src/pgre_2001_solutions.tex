...
\begin{align}
C_{eq}
= \left(\frac{1}{3\Units{$\mu$ F}} + \frac{1}{6\Units{$\mu$ F}}\right)^{-1}
= \frac{6\Units{$\mu$ F}}{3\Units{$\mu$ F}} = 2\Units{$\mu$ F} \nonumber
\end{align}
\\
...
\begin{gather}
C = \frac{1}{L \omega^{2}} =  \frac{1}{25\Units{mH} (1000\Units{rads/s})^{2}}  = 4\e{-5}\Units{F} = \boxed{40\Units{$\mu$ F}} \nonumber
\end{gather}
}
